                      ...
                      <>
                        ...
                        {activeTab === 'alerts' && (
                          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
                            ...
                            <div className="glass-panel" style={{ padding: '24px' }}>
                              <div className="chart-title" style={{ borderBottom: '1px solid var(--border)', paddingBottom: '12px', marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                                <img src="/twitch_logo.png" alt="Twitch" style={{ width: '20px', height: '20px', objectFit: 'contain' }} />
                                Twitch Alerts
                              </div>
                                  ...
                                  <table className="dashboard-table">
                                    ...
                                    <tbody>
                                      {alertsList.map(a => {
                                        ...
                                        return (
                                          <tr key={key}>
                                            <td><span style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '3px 8px', borderRadius: '3px', fontSize: '11px', fontWeight: 700, background: a.platform === 'youtube' ? 'rgba(255,0,0,0.12)' : 'rgba(145,70,255,0.12)', color: a.platform === 'youtube' ? '#ff4444' : '#9146FF' }}><img src={a.platform === 'youtube' ? '/youtube_logo.png' : '/twitch_logo.png'} alt={a.platform} style={{ width: '13px', height: '13px', objectFit: 'contain' }} />{a.platform === 'youtube' ? 'YouTube' : 'Twitch'}</span></td>
