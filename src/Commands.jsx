...
const COMMANDS = [
  ...
  },
  {
    name: 'claim',
    category: 'economy',
    desc: 'Claim your periodic server allowance (daily: 200 coins, weekly: 1,000–3,500 random coins, monthly: 5,000–15,000 random coins).',
    usage: '/claim [reward]',
    options: [
      { name: 'reward', type: 'Choice', required: true, desc: 'daily · weekly · monthly' }
    ],
    admin: false,
    dashboard: false,
  },
  ...
  },
  {
    name: 'chop',
    category: 'economy',
    desc: 'Chop wood in the forest for logs. Requires an Axe (craftable or purchaseable). 7 wood tiers from Pine Log up to legendary Golden Sap. 45-second cooldown.',
    usage: '/chop',
    options: [],
    admin: false,
    dashboard: false,
  },
  {
    name: 'hack',
    category: 'economy',
    desc: 'Bypass mainframe cyber-security nodes using an interactive interface. Requires a Hacker Laptop. Choose Low, Medium, or High Risk nodes for custom coin & data exfiltration loot. Cooldown: 10m.',
    usage: '/hack',
    options: [],
    admin: false,
    dashboard: false,
  ...
  },
  {
    name: 'sell',
    category: 'economy',
    desc: 'Sell grinding loot (logs, fish, crops, gems, hacked files) to the merchant for dynamic, player-driven supply and demand market prices with clan XP & cash bonuses.',
  ...
  },
  {
    name: 'farm view',
    category: 'economy',
    desc: 'View your virtual garden plots status, crop growth stages, active fertilizers, pests, and farming skill level.',
    usage: '/farm view',
    options: [],
    admin: false,
    dashboard: false,
  },
  {
    name: 'farm plant',
    category: 'economy',
    desc: 'Plant a seed from your inventory on a specific empty garden plot (1 to max plots).',
    usage: '/farm plant [seed] [plot]',
    options: [
      { name: 'seed', type: 'Choice', required: true, desc: 'Wheat Seed · Tomato Seed · Carrot Seed · Golden Apple Seed' },
      { name: 'plot', type: 'Integer', required: true, desc: 'Garden plot slot index (1 to max)' },
    ],
    admin: false,
    dashboard: false,
  },
  {
    name: 'farm water',
    category: 'economy',
    desc: 'Irrigate and water growing crops to accelerate their growth (reduces remaining growth time by 25%). Beware: damp soil has a 15% chance to attract pests!',
    usage: '/farm water [plot]',
    options: [
      { name: 'plot', type: 'Integer', required: true, desc: 'Plot slot number to water' },
    ],
    admin: false,
    dashboard: false,
  },
  {
    ...
    options: [
      ...
      { name: 'plot', type: 'Integer', required: true, desc: 'Plot slot number to fertilize' },
    ],
    admin: false,
    dashboard: false,
  },
  ...
  },
  {
    name: 'farm harvest',
    category: 'economy',
    desc: 'Harvest a fully-grown clean crop to store the yield in your inventory. Farming level increases odds for Silver and Gold Star qualities!',
    usage: '/farm harvest [plot]',
    options: [
      { name: 'plot', type: 'Integer', required: true, desc: 'Plot slot number to harvest' },
    ],
    admin: false,
    dashboard: false,
  },
  {
    name: 'farm expand',
    category: 'economy',
    desc: 'Buy another garden plot to plant more crops concurrently. Upgrades from 3 plots up to a max of 8 plots.',
    usage: '/farm expand',
    options: [],
    admin: false,
    dashboard: false,
  },
  {
    name: 'quest view',
    category: 'economy',
    desc: 'Open your daily quests board showing 3 random challenges, current progress bars, and coin + XP rewards.',
    usage: '/quest view',
    options: [],
    admin: false,
    dashboard: false,
  },
  {
    name: 'quest claim',
    category: 'economy',
    desc: 'Claim rewards for a completed daily quest.',
    usage: '/quest claim [index]',
    options: [
      { name: 'index', type: 'Integer', required: true, desc: 'Quest index to claim (1, 2, or 3)' },
    ],
    admin: false,
    dashboard: false,
  },
  {
    name: 'craft list',
    category: 'economy',
    desc: 'View all blueprints and recipes in the crafting catalog, including required logs, ores, and scraps.',
    usage: '/craft list',
    options: [],
    admin: false,
    dashboard: false,
  ...
  },
  {
    name: 'market index',
    category: 'economy',
    desc: 'View the dynamic supply & demand commodity prices and active market event modifiers.',
    usage: '/market index',
    options: [],
    admin: false,
    dashboard: false,
  ...
  },
  {
    name: 'crime',
    category: 'economy',
    desc: 'Brave interactive choice-based crime scenarios (Pickpocket, Carjack, Bank Fraud) to earn cash and Street Cred (Crime XP). Bank Fraud requires Crime Level 6. Higher Crime Level unlocks advanced options. Cooldown: 30m.',
    usage: '/crime [type]',
    options: [
  ...
  },
  {
    name: 'lottery view',
    category: 'economy',
    desc: 'View the daily server-wide lottery jackpot pool, ticket prices, draw timers, and your winning odds.',
    usage: '/lottery view',
    options: [],
    admin: false,
    dashboard: false,
  },
  {
    name: 'lottery buy',
    category: 'economy',
    desc: 'Purchase tickets for the daily lottery jackpot draw (100 coins each) to increase your winning odds.',
    usage: '/lottery buy [amount]',
    options: [
      { name: 'amount', type: 'Integer', required: true, desc: 'Quantity of tickets to buy' },
    ],
    admin: false,
    dashboard: false,
  },
  {
    name: 'lottery draw',
    category: 'economy',
    desc: 'Administrator-only command to immediately draw the daily lottery jackpot and distribute rewards.',
    usage: '/lottery draw',
    options: [],
    admin: true,
    dashboard: false,
  ...
  },
  {
    ...
    category: 'clan',
    desc: 'View the top clans on this server ranked by treasury wealth or level.',
    usage: '/clan leaderboard [sort?]',
    options: [
      { name: 'sort', type: 'Choice', required: false, desc: 'Sort by: treasury · level' }
    ],
    admin: false,
    dashboard: false,
  },
  {
    name: 'clan rename',
    category: 'clan',
    desc: 'Rename your clan (costs 2,500 coins from the clan treasury, owner only).',
    usage: '/clan rename [name]',
    options: [
      { name: 'name', type: 'String', required: true, desc: 'New clan name (2–20 chars)' },
    ],
    admin: false,
    dashboard: false,
  },
  {
    name: 'clan disband',
    category: 'clan',
    desc: 'Permanently disband your clan. All members are released (owner only).',
    usage: '/clan disband',
    options: [],
    admin: false,
    dashboard: false,
